    ...
    <div class="row">
      <div class="col-md-12">
            <div class="panel panel-default">
                <div class="panel-heading"><strong>Editar Asistencia Reunion : {{  $meeting->date }}  | {{  $meeting->place }} | {{  $meeting->attendant }}</strong></div>
                <div class="panel-body">
                        ...
                        <div class="col-md-12" style="margin-top:10px;">
                         <div class="row">
                             ...
                             <button type="submit" class="btn pull-right btn-success">Actualizar Asistencia!</button>
                        </div>
                        </form>
